...
const About = () => {
  ...
  return (
    <>
      <SEO 
        title="من نحن - غاليه | قصة نجاحنا ورسالتنا في عالم الأزياء"
        description="تعرفوا على قصة نجاح غاليه في عالم الأزياء. رسالتنا في تقديم أجود الإسدالات الحريمي بأفضل الأسعار وخدمة عملاء متميزة. جودة، أناقة، وثقة."
        keywords="عن غاليه, قصة النجاح, رسالة الشركة, قيمنا, رؤية غاليه, متجر إسدالات, أزياء نسائية"
        canonical="https://ghalya.vercel.app/about"
