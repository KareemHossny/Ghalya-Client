...
const Home = () => {
  ...
  return (
    <>
      <SEO 
        title="غاليه - أجمل الإسدالات الحريمي بأفضل الأسعار | متجر أونلاين"
        description="اكتشفوا أجمل تشكيلة الإسدالات الحريمي من غاليه. جودة عالية، أسعار مناسبة، توصيل سريع لجميع أنحاء مصر. تسوقي الآن واستمتعي بتجربة شراء فريدة."
        keywords="إسدالات حريمي, ملابس نسائية, موضة, تسوق أونلاين, غاليه, إسدالات, أزياء, ملابس محجبات, أزياء إسلامية"
        canonical="https://ghalya.vercel.app"
