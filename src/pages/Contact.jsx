...
const Contact = () => {
  ...
  return (
    <>
      <SEO 
        title="اتصل بنا - غاليه | خدمة عملاء ودعم فني متكامل"
        description="تواصلوا مع فريق غاليه لأي استفسارات حول المنتجات، الطلبات، أو خدمة العملاء. نحن هنا لمساعدتكم على مدار الساعة."
        keywords="اتصال غاليه, خدمة عملاء, دعم فني, استفسارات, تواصل, معلومات الاتصال"
        canonical="https://ghalya.vercel.app/contact"
