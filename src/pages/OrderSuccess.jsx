...
const OrderSuccess = () => {
  ...
  return (
    <>
      <SEO 
        title="تم تأكيد طلبك بنجاح - غاليه"
        description="شكراً لثقتك بغاليه! تم تأكيد طلبك بنجاح وسيتم توصيله خلال 2-5 أيام عمل."
        keywords="تأكيد الطلب, طلب ناجح, غاليه, تسوق أونلاين"
        canonical="https://ghalya.vercel.app/order-success"
        structuredData={orderId ? structuredData : null}
      />
