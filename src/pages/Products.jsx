...
const Products = () => {
  ...
  return (
    <>
      <SEO 
        title="تشكيلة المنتجات - غاليه | إسدالات حريمي متنوعة وأسعار مميزة"
        description="تصفحوا تشكيلة غاليه الكاملة من الإسدالات الحريمي. منتجات عالية الجودة، مقاسات متنوعة، وأسعار منافسة. اكتشفوا الأكثر مبيعاً والعروض الخاصة."
        keywords="إسدالات, منتجات نسائية, أزياء حريمي, تسوق, عروض, الأكثر مبيعاً, ملابس محجبات, أزياء إسلامية"
        canonical="https://ghalya.vercel.app/products"
